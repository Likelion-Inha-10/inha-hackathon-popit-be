"""
Django settings for popit_project project.
...
SECRET_KEY = 'django-insecure-@(d-*8h#%#&3!on^m2kor%wjecr0z!_12_fobm02zqmbv8()l-'
...
ROOT_URLCONF = 'popit_project.urls'
...
WSGI_APPLICATION = 'popit_project.wsgi.application'
